...
2. 點擊 "打開 Excel 文件" 按鈕，選擇您的 `input.xlsx` 文件。
3. 選擇保存 QR 代碼圖片的文件夾。
4. 程序會根據 Excel 文件中的數據生成 QR 代碼，並將每個 QR 代碼保存為 PNG 文件，命名為圖片名稱（例如 `QR_Code_1.png`）。
